  ...
  useEffect(() => {
    if (isOpen && mode === "edit" && data) {
      ...
      form.setFieldsValue({
        ...
        start_time: voucher?.start_time ? dayjs(voucher.start_time) : null,
        end_time: voucher?.end_time ? dayjs(voucher.end_time) : null,
        discount_percent: voucher?.discount_percent,
        max_discount: voucher?.max_discount,
        min_order_total_price: voucher?.min_order_total_price,
        type: voucher?.type,
